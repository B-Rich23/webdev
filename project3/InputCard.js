        ...
        <View style={styles.contentView}>
          <View style={{ backgroundColor: "rgba(49, 111,244, 1)", width: SCREEN_WIDTH, alignItems: "center" }}>
            ...
            <View style={styles.overlay}>
              ...
              <Input containerStyle={{ borderWidth: 1, borderColor: "white", borderLeftWidth: 0, height: 50,
               width: SCREEN_WIDTH - 80, backgroundColor: "white" }} icon={<MaterialIcon name="email-outline" color="gray" size={25} />}
            ...
            <View style={[styles.overlay, { marginBottom: 30, marginTop: 1 }]}>
              <View style={styles.triangleLeft} />
              <Input containerStyle={{ borderWidth: 1, borderColor: "white", borderLeftWidth: 0, height: 50, width: SCREEN_WIDTH - 80,
          ...
          <View style={{ backgroundColor: "rgba(44, 244, 250, 1)", width: SCREEN_WIDTH, alignItems: "center" }}>
            ...
            <Input containerStyle={{ borderRadius: 40, borderWidth: 1, 
            	borderColor: "white", height: 50, width: SCREEN_WIDTH - 50, 
            	marginVertical: 10, backgroundColor: "white" }} icon={<SimpleIcon name="user" color="gray" size={25} />} 
            ...
            <Input containerStyle={{ borderRadius: 40, borderWidth: 1,
             borderColor: "white", height: 50, width: SCREEN_WIDTH - 50,
             marginVertical: 10, backgroundColor: "white" }} icon={<MaterialIcon name="email-outline" color="gray" size={25} />}
            ...
            <Input containerStyle={{ borderRadius: 40, borderWidth: 1,
             borderColor: "white", height: 50, width: SCREEN_WIDTH - 50,
             marginVertical: 10, backgroundColor: "white" }} icon={<SimpleIcon name="lock" color="rgba(110, 120, 170, 1)" size={25} />} 
            ...
            <Input containerStyle={{ borderRadius: 40, borderWidth: 1,
             borderColor: "white", height: 50, width: SCREEN_WIDTH - 50, 
             marginTop: 10, marginBottom: 30, backgroundColor: "white" }} icon={<SimpleIcon name="lock" color="rgba(110, 120, 170, 1)" size={25} />} 
